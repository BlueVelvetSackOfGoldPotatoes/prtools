...
%   B     Cell structure of M strings (optional; default: B = A)107
%   W     Vector of K weights (optional; default: [1 1])
%   LAM   Parameter used to scale the intermediate kernels; in (0,1]
%         (optional; default: 1)
...
% Dynamic programming is used to compute the string kernel. K is
% a matrix. If dataset is needed, it should be created afterwards.
%
% DEFAULT
%   B   = A
%   W   = [1 1]
