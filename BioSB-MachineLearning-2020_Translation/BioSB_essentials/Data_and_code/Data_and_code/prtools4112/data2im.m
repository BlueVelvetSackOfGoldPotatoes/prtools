...
function im = data2im(a,J)
	...
	[m,k] = size(a);
	[objsize,featsize] = get(a,'objsize','featsize');
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prtools4112/data2im.m
 fn: data2im -------------
