...
%if isa(k,'dataset') & ismapping(j)
	...
	% On second sight a fixed mapping is needed for handlibg datafiles
	% w = mapping(mfilename,'trained',j(:)',[],k,length(j));
	w = mapping(mfilename,'fixed',j(:)',[],k,length(j));
	w = setname(w,'Feature Selection');
end

fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prtools4112/featsel.m
 fn: featsel -------------
