...
% MICC-IKAT, Maastricht University, Maastricht, The Netherlands
    ...
    if nargin <= 1 || (nargin >= 2 && ~isa(TYPE, 'mapping'))
        ...
        if ~exist('A', 'var') || isempty(A)
            W = mapping('lssvc', 'untrained', data); 
            W = setname(W, name);
            return;
        end
        ...
        W = mapping('lssvc', 'trained', data, getlablist(A), k, c); 
        W = setname(W, name);
    
        
    % Apply LS-SVM mapping B on dataset A
    elseif nargin == 2 && isa(TYPE, 'mapping')
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prtools4112/lssvc.m
 fn: lssvc -------------
