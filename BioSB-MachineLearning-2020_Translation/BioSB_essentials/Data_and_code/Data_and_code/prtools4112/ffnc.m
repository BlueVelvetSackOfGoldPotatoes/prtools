...
function [w,hist] = ffnc(alg,a,units,max_iter,w_ini,tt,fid)
  ...
  perf_fn     = 'mse';            % Performance function
	...
	elseif (strcmp(alg,'lmnc'))
		...
		% Amin: commented to work with new matlab versions
        ...
        tp.showWindow = 0; %% Amin: changed to work with new matlab versions
        tp.showCommandLine = 0; %% Amin: changed to work with new matlab versions
	end;
  ...
  while ((iter <= 2*opt_iter) | (iter < burnin)) & ...
	...
	%prwaitbar(0); % Amin: commented to work with new matlab versions
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prtools4112/ffnc.m
 fn: ffnc -------------
