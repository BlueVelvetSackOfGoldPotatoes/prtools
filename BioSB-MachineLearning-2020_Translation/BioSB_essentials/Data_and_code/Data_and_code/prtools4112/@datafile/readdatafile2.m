...
function b = preprocessing(b,preproc,dfile,fext)
	...
	if isa(f,'uint8') | isa(f,'uint16')
		f = double(f)/256; % needed for color image display
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prtools4112/@datafile/readdatafile2.m
 fn: readdatafile2 -------------
