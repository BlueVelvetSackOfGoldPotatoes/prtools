function [path,loglik] = viterbi_path(prior, transmat, obslik,varargin)
...
% PM281108 added loglik to outputs & scaled as an optional argument:
% 'scaled' - 0: Viterbi, 1: Viterbi with scaling [0]

  
scaled = process_options(varargin, 'scaled', 0);
