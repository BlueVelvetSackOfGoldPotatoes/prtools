function [x,strvals] = readdataset(fname,strtype)
%     [X,STRVALS] = READDATASET(FNAME)
%
...
fid = fopen(fname,'r');
if fid==-1
	error('I cannot open file %d.',fname);
end
% get the first line:
dline = fgetl(fid);
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prdatasets/readdataset.m
 fn: readdataset -------------
