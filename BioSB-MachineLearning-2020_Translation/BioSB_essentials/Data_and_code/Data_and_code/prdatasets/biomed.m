...
a = load('biomed.dat');
x = dataset(a(:,[3 5 6 7 8]),cl(a(:,end)));
x = setfeatlab(x,fl);
x = setname(x,'Biomed');
...
fp: /home/goncalo/Documents/RUG/TA_Positions/BioCS/BioSB/BioSB-MachineLearning-2020/website/Data_and_code/Data and code/prdatasets/biomed.m
 fn: biomed -------------
